...
const StatsModal = ({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center px-4">
      <div className="bg-secondary p-4 rounded-lg max-w-md w-full sm:w-auto relative mx-4">
        ...
        <p>
          <span className="text-xs">{isMultiSport ? 'Activities:': 'Runs:'}</span>
          <span className="float-right">{stats.runs}</span>
        </p>
        <p>
          <span className="text-xs">Minimum days:</span>
        ...
        {extraFreq > 1 ? (
          <p>
            <span className="text-xs">Extras every:</span>
            <span className="float-right">{extraFreq} days</span>
          </p>
        ) : (
          <p>
            <span className="text-xs">Minimum day every:</span>
