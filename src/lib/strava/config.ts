...
export const UPSTASH_REDIS_REST_URL = process.env.NEXT_PUBLIC_UPSTASH_REDIS_REST_URL;
export const UPSTASH_REDIS_REST_TOKEN = process.env.NEXT_PUBLIC_UPSTASH_REDIS_REST_TOKEN;
export const STRAVA_API_LIMIT = parseInt(process.env.NEXT_PUBLIC_STRAVA_API_LIMIT || '10');
